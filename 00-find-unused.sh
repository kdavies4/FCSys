...
# Quantities
for s in  Acceleration Amount AmountReciprocal Angle Angle2 Area Capacitance ConductanceElectrical Current CurrentAbsolute CurrentAreic CurrentAreicAbsolute CurrentRate Density DensityRate Energy Fluidity Force Frequency Inductance Length LengthSpecific MagneticFlux MagneticFluxAreic MagneticFluxReciprocal Mass MassRate MassSpecific Mobility MomentumRotational Number NumberAbsolute Permeability Permittivity PermittivityReciprocal Potential PotentialAbsolute PotentialPerWavenumber PotentialRate Power PowerArea PowerAreic PowerAreicPerPotential4 PowerRadiant Pressure PressureAbsolute PressureRate PressureReciprocal ResistanceElectrical Resistivity ResistivityMaterial Time TimeAbsolute Velocity Velocity2 VelocityReciprocal Volume VolumeRate VolumeSpecific VolumeSpecificAbsolute VolumeSpecificRate Wavenumber
do

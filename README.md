...
the Modelica code (starting at the [top level](FCSys 0.1/package.mo)).

![Diagram of the fuel cell model](FCSys 0.1/Resources/Documentation/FCSys.Assemblies.Cells.CellD.png)

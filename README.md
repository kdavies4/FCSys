...
the Modelica code (starting at the [top level](FCSys 0.2.6/package.mo)).

![Diagram of the fuel cell model](FCSys 0.2.6/Resources/Documentation/FCSys.Assemblies.Cells.CellD.png)
...
or
[ModelicaLicense2.html](FCSys 0.2.6/Resources/Documentation/ModelicaLicense2.html)).

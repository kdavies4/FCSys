...
package Figures "Graphical layouts for documentation"
  ...
  model SingleLayerIcon
    ...
    Subregions.SingleLayer SingleLayer
      annotation (Placement(transformation(extent={{-100,-100},{100,100}})));
  ...
  protected
    ...
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{
          ...
          Ellipse(
            ...
            lineThickness=0.5),
          Text(
            extent={{61.5,42},{96,38}},
            lineColor={0,0,0},
            textString="    Instantiation"),
          Text(
            extent={{62,43.8},{96,48}},
            lineColor={0,0,0},
          ...
          Text(
            ...
            textString="Physical"),
          Text(
            extent={{48,28},{72,23.8}},
            lineColor={0,0,0},
            textString="Physical Bus"),
          Text(
            extent={{72,-22},{96,-26}},
            lineColor={0,0,0},
            textString="Potential"),
          Text(
            extent={{48,-18},{72,-22}},
            lineColor={0,0,0},
            textString="Net"),

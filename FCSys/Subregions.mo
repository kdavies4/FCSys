...
package Subregions
  ...
  package Examples "Examples"
    ...
    model SubregionEvaporation
      "Test a subregion with evaporation and condensation"
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC1(liquid(inclH2O=
              true), gas(inclH2O=true, H2O(redeclare
              Conditions.ByConnector.Face.Single.Material.Current material(
                redeclare Modelica.Blocks.Sources.Pulse source(
                amplitude=-U.A,
                width=0.01,
                period=10000,
            ...
            rotation=90,
            origin={-24,0})));
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC2(gas(inclH2O=
              true), liquid(inclH2O=true)) annotation (Placement(transformation(
            extent={{-10,10},{10,-10}},
            rotation=90,
            origin={24,0})));
  ...
  and some of it condenses.  All of this occurs at a fixed temperature (25 &deg;C).</p></html>"),
    ...
    model SaturationPressure
      ...
      import Modelica.Media.Air.MoistAir.saturationPressureLiquid;

      output Q.Pressure p_sat=saturationPressureLiquid(subregion.gas.H2O.T/U.K)
          *U.Pa "Saturation pressure via Modelica.Media";
      output Q.Number T_degC=U.to_degC(subregion.gas.H2O.T)
        "Temperature in degree Celcius";

      // **elim dynamic state selection
      extends Examples.Subregion(
        inclH2O=true,
        inclH2=false,
        subregion(gas(H2O(
              p_IC=saturationPressureLiquid(environment.T/U.K)*U.Pa,
              redeclare package Data = FCSys.Characteristics.H2O.Gas,
              consTransX=FCSys.Subregions.Species.BaseClasses.Conservation.IC)),
            liquid(inclH2O=inclH2O, H2O(consTransX=FCSys.Subregions.Species.BaseClasses.Conservation.IC))),

        environment(T=274.15*U.K));

      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC1(liquid(inclH2O=
              true, H2O(redeclare
              Conditions.ByConnector.Face.Single.Thermal.Temperature thermal(
                redeclare Modelica.Blocks.Sources.Ramp source(
                height=99*U.K,
                duration=1000,
                offset=environment.T)))), gas(inclH2O=true, H2O(redeclare
              Conditions.ByConnector.Face.Single.Thermal.Temperature thermal(
                redeclare Modelica.Blocks.Sources.Ramp source(
                height=99*U.K,
                duration=1000,
                offset=environment.T))))) annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-24,0})));
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC2(gas(inclH2O=
              ...
              Conditions.ByConnector.Face.Single.Thermal.Temperature thermal(
                ...
                height=99*U.K,
                duration=1000,
                offset=environment.T)))), liquid(inclH2O=true, H2O(redeclare
              Conditions.ByConnector.Face.Single.Thermal.Temperature thermal(
                redeclare Modelica.Blocks.Sources.Ramp source(
                height=99*U.K,
                duration=1000,
    ...
    model SubregionHydration
      ...
      annotation (experiment(StopTime=0.003, Tolerance=1e-06), Commands(file(
            ...
            "Subregions.Examples.SubregionHydration.mos"));
...
*/
      ...
      extends Examples.Subregion(
        ...
        subregion(
          ...
          gas(H2(consTransX=Conservation.IC, initMaterial=InitScalar.None)),
          graphite(
            reduceTemp=true,
...
*/
    ...
    model SubregionPipeFlow
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC1(
        ...
        gas(
          ...
          final inclN2=inclN2,
          final inclO2=inclO2,
          H2(redeclare Conditions.ByConnector.Face.Single.Translational.Force
              normal, redeclare
              Conditions.ByConnector.Face.Single.Material.Pressure material(
                source(y=environment.p - Deltap/2))),
          H2O(redeclare Conditions.ByConnector.Face.Single.Translational.Force
              normal, redeclare
              Conditions.ByConnector.Face.Single.Material.Pressure material(
                source(y=environment.p - Deltap/2))),
          N2(redeclare Conditions.ByConnector.Face.Single.Translational.Force
              normal, redeclare
              Conditions.ByConnector.Face.Single.Material.Pressure material(
                source(y=environment.p - Deltap/2))),
          O2(redeclare Conditions.ByConnector.Face.Single.Translational.Force
              normal, redeclare
              Conditions.ByConnector.Face.Single.Material.Pressure material(
                source(y=environment.p - Deltap/2))))) annotation (Placement(
            transformation(
            extent={{-10,10},{10,-10}},
            rotation=270,
            origin={-24,0})));
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBus BC3(
        ...
        gas(
          ...
          final inclN2=inclN2,
          final inclO2=inclO2,
          H2(redeclare Conditions.ByConnector.Face.Single.Material.Current
              material),
          H2O(redeclare Conditions.ByConnector.Face.Single.Material.Current
              material),
          N2(redeclare Conditions.ByConnector.Face.Single.Material.Current
              material),
          O2(redeclare Conditions.ByConnector.Face.Single.Material.Current
              material))) annotation (Placement(transformation(
            extent={{-10,10},{10,-10}},
            rotation=0,
            origin={0,-24})));
    ...
    equation
      ...
      annotation (experiment(StopTime=200, Algorithm="Dassl"), Commands(file(
            ...
            "Subregions.Examples.SubregionPipeFlow.mos"));
    ...
    model Subregions
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC1(
        gas(
          ...
          final inclO2=inclO2),
        ionomer('inclC19HF37O5S-'=false, final 'inclH+'='inclH+'),
        graphite('inclC+'=false,final 'incle-'='incle-')) annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-56,0})));
    ...
    model SubregionsSound
      ...
      annotation (experiment(StopTime=0.0003, Tolerance=1e-06), Commands(file(
              ensureTranslated=true) =
            "Resources/Scripts/Dymola/Subregions.Examples.SubregionsSound.mos"
            "Subregions.Examples.SubregionsSound.mos"));

    end SubregionsSound;

    model SubregionsSoundUpstream "**with upstream discretization"
      extends Subregions(
        'inclC+'=false,
        subregion1(gas(
            H2(upstreamX=true),
            ...
            O2(upstreamX=true))),
        subregions(gas(
            each H2(upstreamX=true),
            each H2O(upstreamX=true),
            each N2(upstreamX=true),
            each O2(upstreamX=true))),
        subregion2(gas(
            H2(upstreamX=true),
            H2O(upstreamX=true),
            N2(upstreamX=true),
      ...
      annotation (experiment(StopTime=0.0003, Tolerance=1e-06), Commands(file(
              ensureTranslated=true) =
            "Resources/Scripts/Dymola/Subregions.Examples.SubregionsSoundUpstream.mos"
            "Subregions.Examples.SubregionsSoundUpstream.mos"));
    end SubregionsSoundUpstream;
    ...
    model ElectricalConduction
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC1(
        ...
        graphite(
          ...
          'e-'(redeclare
              Conditions.ByConnector.Face.Single.Translational.Current normal(A
                =U.mm^2, redeclare Modelica.Blocks.Sources.RealExpression
    ...
    **Discuss time constant.
    ...
    model ThermalConduction "Test thermal conduction (through solid)"
      extends Examples.Subregions(
        ...
        'inclC+'=true,
        inclH2=false,
        subregion1(graphite('C+'(T_IC=1.1*environment.T, initMaterial=
                  InitScalar.Pressure))),
    ...
    model ThermalConductionConvection
      ...
      extends Examples.Subregions(
        ...
        subregion1(gas(N2(
              ...
              p_IC=environment.p,
              T(displayUnit="degC"),
              phi(displayUnit="mm/s"))), graphite('C+'(T_IC=1.1*environment.T,
...
*/
      ...
      ChemicalExchange exchange1(n=-2, m=U.g/U.mol)
        annotation (Placement(transformation(extent={{-50,-30},{-30,-10}})));
      FCSys.Subregions.DoubleLayer negativeDL(
        axis=Axis.x,
        minoritySide=Side.p,
        transSubstrate=true,
        initCapacitor=FCSys.Subregions.BaseClasses.InitCapacitor.Potential,
        mu_IC=U.V) "Double layer model for the negative carrier"
        annotation (Placement(transformation(extent={{-10,38},{10,58}})));

      FCSys.Subregions.DoubleLayer positiveDL(
        axis=Axis.x,
        minoritySide=Side.n,
        transSubstrate=false,
        initCapacitor=FCSys.Subregions.BaseClasses.InitCapacitor.Potential)
        "Double layer model for the positive carrier"
        annotation (Placement(transformation(extent={{10,10},{-10,30}})));

      replaceable Conditions.ByConnector.Chemical.Current current(
      ...
      replaceable Conditions.ByConnector.Chemical.Potential potential1(
        each final inclTransX=inclTransX,
        each final inclTransY=inclTransY,
        each final inclTransZ=inclTransZ,
        each sT=U.V)
        annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));
      Conditions.ByConnector.Inert.Inert substrate(
        final inclTransX=inclTransX,
        final inclTransY=inclTransY,
        final inclTransZ=inclTransZ,
        thermal(source(y=environment.T)))
      ...
      Conditions.ByConnector.Face.Single.Face BC1(redeclare
          ...
          normal) annotation (Placement(transformation(
            ...
            rotation=90,
            origin={-44,48})));
      Conditions.ByConnector.Face.Single.Face BC2 annotation (Placement(
            transformation(
            extent={{-10,10},{10,-10}},
            rotation=90,
            origin={44,48})));
    ...
    public
      Conditions.ByConnector.Face.Single.Face BC4(redeclare
          FCSys.Conditions.ByConnector.Face.Single.Translational.Velocity
          normal(source(y=BC4.normal.face.mPhidot[1])), redeclare
          FCSys.Conditions.ByConnector.Face.Single.Material.Current material)
        annotation (Placement(transformation(
            extent={{-10,10},{10,-10}},
            rotation=90,
            origin={44,20})));
      Conditions.ByConnector.Face.Single.Face BC3 annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-44,20})));
      ChemicalExchange exchange2(n=-2, m=U.g/U.mol)
        annotation (Placement(transformation(extent={{-50,-50},{-30,-30}})));
      ChemicalExchange exchange3(m=U.g/U.mol, n=1)
        annotation (Placement(transformation(extent={{-50,-70},{-30,-50}})));
      replaceable Conditions.ByConnector.Chemical.Potential potential2(
        each sT=0,
        each final inclTransX=inclTransX,
        each final inclTransY=inclTransY,
        each final inclTransZ=inclTransZ)
    ...
    equation
      ...
      connect(negativeDL.inert, substrate.inert) annotation (Line(
          points={{6.10623e-16,44},{4,40},{20,40},{20,-6.66134e-16}},
          color={47,107,251},
          smooth=Smooth.None));
      connect(positiveDL.inert, substrate.inert) annotation (Line(
          points={{-6.10623e-16,16},{4,12},{20,12},{20,-6.66134e-16}},
          color={47,107,251},
          smooth=Smooth.None));
      connect(exchange1.reaction, negativeDL.chemical) annotation (Line(
          points={{-38,-20},{-20,-20},{-20,40},{-8,40},{0,48},{6.10623e-16,48}},

          color={255,195,38},
          smooth=Smooth.None));

      connect(exchange2.reaction, positiveDL.chemical) annotation (Line(
          points={{-38,-40},{-20,-40},{-20,12},{-8,12},{0,20},{-6.10623e-16,20}},

          color={255,195,38},
          smooth=Smooth.None));

      connect(BC1.face, negativeDL.majority) annotation (Line(
          points={{-40,48},{-10,48}},
          color={127,127,127},
          smooth=Smooth.None));
      connect(negativeDL.minority, BC2.face) annotation (Line(
          points={{10,48},{40,48}},
          color={127,127,127},
          smooth=Smooth.None));
      connect(BC3.face, positiveDL.minority) annotation (Line(
          points={{-40,20},{-10,20}},
          color={127,127,127},
          smooth=Smooth.None));
      connect(BC4.face, positiveDL.majority) annotation (Line(
          points={{40,20},{10,20}},
          color={127,127,127},
          smooth=Smooth.None));
      connect(potential1.chemical, exchange1.species) annotation (Line(
          points={{-70,-14},{-70,-20},{-42,-20}},
          color={255,195,38},
          smooth=Smooth.None));
      connect(potential2.chemical, exchange2.species) annotation (Line(
          points={{-70,-34},{-70,-40},{-42,-40}},
          color={255,195,38},
          smooth=Smooth.None));
      connect(current.chemical, exchange3.species) annotation (Line(
          points={{-70,-54},{-70,-60},{-42,-60}},
          color={255,195,38},
          smooth=Smooth.None));
      connect(exchange2.reaction, exchange1.reaction) annotation (Line(
          points={{-38,-40},{-20,-40},{-20,-20},{-38,-20}},
          color={255,195,38},
          smooth=Smooth.None));
      connect(exchange3.reaction, exchange2.reaction) annotation (Line(
          points={{-38,-60},{-20,-60},{-20,-40},{-38,-40}},
          color={255,195,38},
          smooth=Smooth.None));
      annotation (
    ...
    model SubregionsColumn
      "<html>Test a one-dimensional array of subregions with an initial pressure difference (C<sup>+</sup> and H<sub>2</sub> included by default)</html>"
      extends Modelica.Icons.Example;

      // **get to work without carbon
      ...
      parameter Q.Pressure Deltap_IC=0*U.Pa
        "<html>Initial pressure difference (&Delta;<i>p</i><sub>IC</sub>)</html>";
      parameter Boolean 'inclC+'=true
        "<html>Carbon plus (C<sup>+</sup>)</html>" annotation (choices(
            __Dymola_checkBox=true), Dialog(group="Species",
      ...
      parameter Boolean inclH2O=false
        "<html>Water vapor (H<sub>2</sub>O)</html>" annotation (choices(
            __Dymola_checkBox=true), Dialog(group="Species",
            __Dymola_descriptionLabel=true));
      parameter Boolean inclN2=true "<html>Nitrogen (N<sub>2</sub>)</html>"
        annotation (choices(__Dymola_checkBox=true), Dialog(group="Species",
            __Dymola_descriptionLabel=true));
      parameter Boolean inclO2=false "<html>Oxygen (O<sub>2</sub>)</html>"
        annotation (choices(__Dymola_checkBox=true), Dialog(group="Species",
      ...
      FCSys.Subregions.Subregion subregion1(
        ...
        gas(
          ...
          final inclN2=inclN2,
          final inclO2=inclO2,
          H2O(p_IC=environment.p + Deltap_IC/2, upstreamY=false),
          O2(p_IC=environment.p + Deltap_IC/2, upstreamY=false),
          H2(p_IC=environment.p + Deltap_IC/2, upstreamY=false),
      ...
      FCSys.Subregions.Subregion subregions[n_y](
        ...
        gas(
          ...
          each final inclN2=inclN2,
          each final inclO2=inclO2,
          H2(p_IC=subregions.gas.N2.p_IC, each upstreamY=false),
          H2O(p_IC=subregions.gas.N2.p_IC, each upstreamY=false),
          N2(p_IC={environment.p + Deltap_IC/2 - i*Deltap_IC/(n_y + 1) for i
                 in 1:n_y}, each upstreamY=false),
          O2(p_IC=subregions.gas.N2.p_IC, each upstreamY=false)),
        liquid(H2O(each V_IC=subregions[1].V/4)),
    ...
    equation
      ...
      annotation (
        ...
        experiment(
          ...
          Algorithm="Dassl"),
        Commands(file(ensureTranslated=true) =
            "Resources/Scripts/Dymola/Subregions.Examples.SubregionsColumn.mos"
            "Subregions.Examples.SubregionsColumn.mos"),
        experimentSetupOutput);
    end SubregionsColumn;
...
<p>Please see the documentation of the
  ...
  package Phases "Phases or mixtures of species"
    ...
    model Gas "Gas phase"
      ...
      ChemicalExchange HOR(final m=H2.Data.m, n=-1) if inclHOR
      ...
      Connectors.ChemicalNet chemical if inclHOR or inclORR
...
<p>Please see the documentation of the <a href=\"modelica://FCSys.Subregions.Phases.BaseClasses.EmptyPhase\">EmptyPhase</a> model.</p></html>"));
    ...
    model Graphite "Graphite phase"
      ...
      ChemicalExchange HOR(final m='e-'.Data.m, n=2) if inclHOR
      ...
      DoubleLayer HODL(
        transSubstrate=true,
        axis=Axis.x,
        minoritySide=Side.p) if inclHOR "Double layer for hydrogen oxidation"
        annotation (Placement(transformation(extent={{-10,78},{10,98}})));

      DoubleLayer ORDL(
        transSubstrate=true,
        axis=Axis.x,
        minoritySide=Side.n) if inclORR "Double layer for oxygen reduction"
    ...
    equation
      ...
      connect('e-'.chemical, HOR.species) annotation (Line(
          points={{-3.9,7},{-10,14},{-10,50},{-18,50}},
          color={255,195,38},
          smooth=Smooth.None));
      connect(HOR.reaction, chemical) annotation (Line(
          points={{-22,50},{-40,50}},
          color={255,195,38},
          smooth=Smooth.None));
      connect(HODL.majority, 'e-'.faces[1, Side.p]) annotation (Line(
          points={{-10,88},{-50,88},{-50,5.55112e-16},{5.55112e-16,5.55112e-16}},

          color={127,127,127},
          smooth=Smooth.None));

      connect(HODL.minority, 'e-'.faces[1, Side.n]) annotation (Line(
          points={{10,88},{50,88},{50,5.55112e-16},{5.55112e-16,5.55112e-16}},
          color={127,127,127},
          smooth=Smooth.None));
      connect(HODL.inert, 'C+'.inert) annotation (Line(
      ...
      connect('e-'.chemical, ORR.species) annotation (Line(
          points={{-3.9,7},{-10,14},{-10,30},{-18,30}},
          color={255,195,38},
          smooth=Smooth.None));
      connect(ORR.reaction, chemical) annotation (Line(
          ...
          color={255,195,38},
          smooth=Smooth.None));
      connect(ORDL.majority, 'e-'.faces[1, Side.n]) annotation (Line(
          points={{10,68},{50,68},{50,5.55112e-16},{5.55112e-16,5.55112e-16}},
          color={127,127,127},
          smooth=Smooth.None));
      connect(ORDL.minority, 'e-'.faces[1, Side.p]) annotation (Line(
          points={{-10,68},{-50,68},{-50,5.55112e-16},{5.55112e-16,5.55112e-16}},

          color={127,127,127},
          smooth=Smooth.None));

      connect(ORDL.inert, 'C+'.inert) annotation (Line(
      ...
      connect('e-'.faces[facesCart[Axis.z], Side.p], zPositive.'e-')
        annotation (Line(
          ...
          color={127,127,127},
          smooth=Smooth.None));
      connect(ORDL.chemical, chemical) annotation (Line(
          points={{-6.10623e-16,68},{-8,60},{-30,60},{-30,50},{-40,50}},
          color={255,195,38},
          smooth=Smooth.None));

      connect(HODL.chemical, chemical) annotation (Line(
          points={{6.10623e-16,88},{-8,80},{-30,80},{-30,50},{-40,50}},
          color={255,195,38},
          smooth=Smooth.None));
      annotation (Documentation(info="<html>
 ...
 <a href=\"modelica://FCSys.Subregions.Phases.BaseClasses.EmptyPhase\">EmptyPhase</a> model.</p></html>"));
    ...
    model Ionomer "Ionomer phase"
      ...
      ChemicalExchange HOR(final m='H+'.Data.m, n=2) if inclHOR
        "Chemical interface with the hydrogen oxidation reaction"
        annotation (Placement(transformation(extent={{-10,40},{-30,60}})));
      ...
      DoubleLayer HODL(
        transSubstrate=false,
        axis=Axis.x,
        minoritySide=Side.n) if inclHOR "Double layer for hydrogen oxidation"
        annotation (Placement(transformation(extent={{10,78},{-10,98}})));

      DoubleLayer ORDL(
        transSubstrate=false,
        axis=Axis.x,
        minoritySide=Side.p) if inclORR "Double layer for oxygen reduction"
        annotation (Placement(transformation(extent={{-10,58},{10,78}})));
    ...
    equation
      ...
      connect(HOR.reaction, chemical) annotation (Line(
          ...
          color={255,195,38},
          smooth=Smooth.None));
      connect(HODL.majority, 'H+'.faces[1, Side.p]) annotation (Line(
          points={{10,88},{50,88},{50,5.55112e-16},{5.55112e-16,5.55112e-16}},
          color={127,127,127},
          smooth=Smooth.None));

      connect(HODL.minority, 'H+'.faces[1, Side.n]) annotation (Line(
          points={{-10,88},{-50,88},{-50,5.55112e-16},{5.55112e-16,5.55112e-16}},

          color={127,127,127},
          smooth=Smooth.None));

      connect(HODL.inert, 'C19HF37O5S-'.inert) annotation (Line(
          points={{-6.10623e-16,84},{4,80},{30,80},{30,-3.8},{6.9,-3.8}},
          color={47,107,251},
          smooth=Smooth.None));
      connect(HOR.reaction, chemical) annotation (Line(
      ...
      connect(ORR.reaction, chemical) annotation (Line(
          ...
          color={255,195,38},
          smooth=Smooth.None));
      connect(ORDL.majority, 'H+'.faces[1, Side.n]) annotation (Line(
          points={{-10,68},{-50,68},{-50,5.55112e-16},{5.55112e-16,5.55112e-16}},

          color={127,127,127},
          smooth=Smooth.None));

      connect(ORDL.minority, 'H+'.faces[1, Side.p]) annotation (Line(
          points={{10,68},{50,68},{50,5.55112e-16},{5.55112e-16,5.55112e-16}},
          color={127,127,127},
          smooth=Smooth.None));
      connect(ORDL.inert, 'C19HF37O5S-'.inert) annotation (Line(
          points={{6.10623e-16,64},{4,60},{30,60},{30,-3.8},{6.9,-3.8}},
          color={47,107,251},
          smooth=Smooth.None));
      connect(ORR.reaction, chemical) annotation (Line(
        ...
        model Fixed "Fixed properties"
          extends Species(
            redeclare replaceable package Data = Characteristics.'e-'.Gas (n_v=
                    {0,0},b_v=Characteristics.'C+'.Graphite.b_v),
            final tauprime=0,
...
<p>For more information, see the <a href=\"modelica://FCSys.Subregions.Species.Species\">Species</a> model.</p></html>"));
        ...
        model Fixed "Fixed properties"
          ...
          extends Species(
            ...
            redeclare parameter Q.ResistivityThermal theta=1e-7*U.m*U.K/(
                25.9e-3*U.W));
...
yet its condition is not defined.  Choose any condition besides None.");
      elseif consMaterial == Conservation.Dynamic then
        ...
        elseif initMaterial == InitScalar.Density then
          1/v = rho_IC;
          assert(Data.isCompressible, Data.formula + " is incompressible,
...
yet its condition is not defined.  Choose any condition besides None.");
      elseif consEnergy == Conservation.Dynamic then
        ...
        elseif initEnergy == InitScalar.Density then
          1/v = rho_IC;
          assert(Data.hasThermalExpansion, Data.formula + " has no thermal expansion,
...
temperature or uniform heat flux.
  ...
  model ChemicalExchange
    ...
    Connectors.ChemicalNet reaction(final n_trans=n_trans)
      "Reaction-side connector" annotation (Placement(transformation(extent={{
              10,-10},{30,10}}), iconTransformation(extent={{10,-10},{30,10}})));
    Connectors.Chemical species(final n_trans=n_trans) "Species-side connector"
  ...
  equation
    ...
    zeros(n_trans) = reaction.mPhidot + m*actualStream(species.phi)*species.Ndot
      "Translational momentum";
    0 = reaction.Qdot + actualStream(species.sT)*species.Ndot "Thermal energy";
  ...
  model DoubleLayer "Electrochemical double layer"
    import FCSys.BaseClasses.Utilities.cartWrap;
    import FCSys.BaseClasses.Utilities.inSign;
    ...
    // Assumptions
    parameter Boolean transSubstrate=true
    ...
    Connectors.ChemicalNet chemical(final n_trans=n_trans,mu(final start=mu_IC,
          final fixed=false)) "Chemical connector" annotation (Placement(
    ...
    Connectors.Inert inert(final n_trans=n_trans)
      "Interface with the substrate" annotation (Placement(transformation(
            extent={{-10,-30},{10,-10}}), iconTransformation(extent={{-10,-50},
              {10,-30}})));
  ...
  equation
    ...
    // ----------
    // Material
    minority.rho = majority.rho*exp(chemical.mu/inert.thermal.T)
      "Integrated result of advection canceling diffusion over the entire double layer";
    minority.Ndot + inSign(minoritySide)*minority.rho*A*minority.phi[1] = 0
      "Advection cancels diffusion at the far side of the minority region";
    C*chemical.mu = N "Static potential is applied to the reaction";
    //
    // Translational
    0 = majority.mPhidot[1] - inSign(minoritySide)*Data.p_Tv(majority.T, 1/
      majority.rho)*A "Translational momentum balances on the majority side";
    0 = minority.mPhidot[1] - inSign(minoritySide)*Data.p_Tv(minority.T, 1/
      minority.rho)*A "Translational momentum balances on the minority side";
    ...
    chemical.Qdot = 0 "No heat transfer from the reaction stream";

    // Conservation (excluding terms which are zero above)
    der(N)/U.s = majority.Ndot "Material";
    zeros(n_trans) = chemical.mPhidot + inert.translational.mPhidot
      "Translational momentum (no storage)";
    0 = chemical.mu*chemical.Ndot + inert.translational.phi*inert.translational.mPhidot
       + inert.thermal.Qdot "Energy (no storage)";
    annotation (
      Documentation(info="<html>

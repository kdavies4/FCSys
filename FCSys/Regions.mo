...
package Regions "3D arrays of discrete, interconnected subregions"
  package Examples "Examples"
    ...
    model FPToFP "Test one flow plate to the other"
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC5[caFP.n_x, n_z](
          each gas(
          inclH2O=true,
          inclN2=true,
          inclO2=true,
          ...
          H2O(thermal(source(k=environment.T))))) annotation (Placement(
            ...
            rotation=180,
            origin={60,-24})));
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC6[caFP.n_x, n_z](
          each gas(
          inclH2O=true,
          inclN2=true,
          inclO2=true,
    ...
    model CLToCL "Test one catalyst layer to the other"
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC1[n_y, n_z](
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC2[n_y, n_z](
        each gas(
          inclH2O=true,
          inclN2=true,
          inclO2=true,
    ...
    model AnFP "Test the anode flow plate"
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC4[anFP.n_x, n_z](
          each gas(inclH2=true, inclH2O=true)) annotation (Placement(
            ...
            rotation=0,
            origin={-60,24})));
      // **fix negative amount of H2O liquid. -- no phase change if reaction rate is zero (see bouncing ball example)
    equation
      connect(BC1.face, anFP.xNegative) annotation (Line(
          points={{-80,3.65701e-16},{-80,6.10623e-16},{-70,6.10623e-16}},
          color={127,127,127},
    ...
    model PEM "Test the proton exchange membrane"
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC1[n_y, n_z](each
          gas(inclH2O=true, H2O(thermal(source(y=environment.T)))), each
          ionomer(
          'inclC19HF37O5S-'=true,
          'inclH+'=true,
          'C19HF37O5S-'(thermal(source(y=environment.T))),
          'H+'(thermal(source(y=environment.T))))) annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-24,0})));
    ...
    model CaFP "Test the cathode flow plate"
      ...
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC2[n_y, n_z](each
          ...
          'C+'(thermal(source(k=environment.T))),
          'e-'(thermal(source(k=environment.T)),redeclare
              Conditions.ByConnector.Face.Single.Material.Density.Density
              material))) annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={84,0})));
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC3[caFP.n_x, n_z](
          each gas(
          inclH2O=true,
          inclN2=true,
          inclO2=true,
          ...
          O2(thermal(source(k=environment.T))))) annotation (Placement(
            ...
            rotation=180,
            origin={60,-24})));
      Conditions.ByConnector.FaceBus.Single.FaceBusIsolated BC4[caFP.n_x, n_z](
          each gas(
          inclH2O=true,
          inclN2=true,
          inclO2=true,
      ...
      extends Region(
        ...
        redeclare replaceable model Subregion = Subregions.SubregionNoIonomer (
            ...
            liquid(
              k=fill(epsilon^(3/2), 3),
              inclH2O=true,
              H2O(V_IC=Modelica.Constants.eps*U.cc)))) annotation (IconMap(
            primitivesVisible=false));

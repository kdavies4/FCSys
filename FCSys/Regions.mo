...
package Regions "3D arrays of discrete, interconnected subregions"
  ...
  package Examples "Examples"
    ...
    equation
      ...
      connect(caGDL.xPositive, caBC.face) annotation (Line(
          points={{50,0},{50,8.88178e-016},{60,8.88178e-016}},
          color={0,0,240},
          thickness=0.5,
          smooth=Smooth.None));
      connect(anCL.xPositive, PEM.xNegative) annotation (Line(
    ...
    model CLToCL "Test one catalyst layer to the other"
      ...
      output Q.Current zI=-sum(anCL.subregions[1, :, :].graphite.'e-'.faces[1,
    ...
    equation
      connect(anBC.face, anCL.xNegative) annotation (Line(
          ...
          thickness=0.5,
          smooth=Smooth.None));
      connect(caCL.xPositive, caBC.face) annotation (Line(
          points={{30,0},{36,0},{36,8.88178e-016},{40,8.88178e-016}},
          color={0,0,240},
          thickness=0.5,
          smooth=Smooth.None));
      connect(anCL.xPositive, PEM.xNegative) annotation (Line(
    ...
    model AnFP "Test the anode flow plate"
      ...
      Conditions.ByConnector.FaceBus.Single.Flows anBC[anFP.n_y, anFP.n_z](
          ...
          'e-'(redeclare Modelica.Blocks.Sources.Ramp materialSet(
              height=-100*U.A,
              duration=20,
              offset=-U.mA)))) annotation (Placement(transformation(
            extent={{10,-10},{-10,10}},
            rotation=90,
            origin={-84,0})));
      Conditions.ByConnector.FaceBus.Single.Flows caBC[anFP.n_y, anFP.n_z](
          each gas(inclH2=true, inclH2O=true), each graphite('incle-'=true,
            'e-'(redeclare function materialSpec =
                FCSys.Conditions.ByConnector.Face.Single.Material.pressure,
    ...
    model AnGDL "Test the anode gas diffusion layer"
      ...
      Conditions.ByConnector.FaceBus.Single.Flows caBC[anGDL.n_y, anGDL.n_z](
        each gas(inclH2=false, inclH2O=true),
        each liquid(inclH2O=false),
        each graphite('incle-'=true, 'e-'(redeclare function materialSpec =
                FCSys.Conditions.ByConnector.Face.Single.Material.pressure,
              materialSet(y=U.bar)))) annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
    ...
    model AnCL "Test the anode catalyst layer"
      ...
      output Q.Potential w=anCL.subregions[1, 1, 1].ionomer.'H+'.g_faces[1,
          Side.p] + anCL.subregions[1, 1, 1].graphite.'e-'.g_faces[1, Side.n]
        if environment.analysis "Electrical potential";
      output Q.Current zI=-sum(anCL.subregions[1, :, :].graphite.'e-'.faces[1,
          Side.n].Ndot) if environment.analysis "Electrical current";
      ...
      Conditions.ByConnector.FaceBus.Single.Efforts caBC[anCL.n_y, anCL.n_z](
          each ionomer('inclH+'=true, inclH2O=false)) annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={4,0})));
    ...
    model PEM "Test the proton exchange membrane"
      ...
      Conditions.ByConnector.FaceBus.Single.Flows anBC[PEM.n_y, PEM.n_z](each
          ...
          H2O(redeclare function materialSpec =
                FCSys.Conditions.ByConnector.Face.Single.Material.pressure,
              materialSet(y=65536*U.kPa)),
          'H+'(redeclare Modelica.Blocks.Sources.Ramp materialSet(
              height=-100*U.A,
              duration=20,
              offset=-U.mA)),
          redeclare FCSys.Conditions.ByConnector.ThermalDiffusion.Temperature
  ...
  due solely to electrical resistance.  Electro-osmotic drag applies additional resistance to the migration of protons.</p>
    ...
    model CaCL "Test the cathode catalyst layer"
      ...
      output Q.Potential w=-caCL.subregions[1, 1, 1].graphite.'e-'.g_faces[1,
          Side.p] - caCL.subregions[1, 1, 1].ionomer.'H+'.g_faces[1, Side.n]
        if environment.analysis "Electrical potential";
      output Q.Current zI=sum(caCL.subregions[1, :, :].graphite.'e-'.faces[1,
          Side.p].Ndot) if environment.analysis "Electrical current";
    ...
    equation
      connect(anBC.face, caCL.xNegative) annotation (Line(
          points={{0,-1.34539e-015},{8,6.10623e-016},{10,6.10623e-016}},
          color={0,0,240},
          thickness=0.5,
          smooth=Smooth.None));

      connect(caCL.xPositive, caBC.face) annotation (Line(
          points={{30,6.10623e-016},{38,6.10623e-016},{38,1.23436e-015},{40,
              1.23436e-015}},
          color={0,0,240},
          thickness=0.5,
          smooth=Smooth.None));
    ...
    equation
      connect(anBC.face, caGDL.xNegative) annotation (Line(
          points={{20,-6.66134e-016},{24,-6.66134e-016},{24,6.10623e-016},{30,
              6.10623e-016}},
          color={0,0,240},
          thickness=0.5,
          smooth=Smooth.None));
      ...
      connect(caGDL.xPositive, caBC.face) annotation (Line(
          points={{50,6.10623e-016},{54,6.10623e-016},{54,2.22045e-016},{60,
              2.22045e-016}},
          color={0,0,240},
          thickness=0.5,
          smooth=Smooth.None));
    ...
    model AnFP "Anode flow plate"
      ...
      extends Region(
        ...
        redeclare replaceable model Subregion =
            ...
            liquid(inclH2O=true, H2O(epsilon_IC=1e-4)))) annotation (IconMap(
      ...
      extends Region(
        ...
        redeclare replaceable model Subregion =
            FCSys.Subregions.SubregionIonomerOnly (ionomer(
              ...
              H2O(final lambda_IC=lambda_IC)))) annotation (IconMap(
            primitivesVisible=false));
...
<p>For more information, please see the
  ...
  package CaCLs "Cathode catalyst layers"
    ...
    model CaCL "Cathode catalyst layer"
      ...
      // Auxiliary variables (for analysis)
      output Q.Potential Deltaw[n_y, n_z]=-subregions[n_x, :, :].graphite.'e-'.g_faces[
          1, Side.p] - subregions[1, :, :].ionomer.'H+'.g_faces[1, Side.n] if
        environment.analysis
        "Electrical potential differences over the yz plane";
      output Q.NumberAbsolute n_O2[n_x, n_y, n_z](each stateSelect=StateSelect.never)
  ...
  package CaFPs "Cathode flow plates"
    ...
    model CaFP "Cathode flow plate"
      ...
      extends Region(
        ...
        redeclare replaceable model Subregion =
            ...
            liquid(
              inclH2O=true,
              k={10,1,1},
              H2O(epsilon_IC=1e-4)))) annotation (IconMap(primitivesVisible=
              false));
      ...
      output Q.PressureAbsolute p_ny[n_x, n_z](each stateSelect=StateSelect.never)
         = subregions[:, 1, :].gas.H2O.faces[2, Side.n].p + subregions[:, 1, :].gas.N2.faces[
        2, Side.n].p + subregions[:, 1, :].gas.O2.faces[2, Side.n].p
      ...
      output Q.PressureAbsolute p_py[n_x, n_z](each stateSelect=StateSelect.never)
         = subregions[:, 1, :].gas.H2O.faces[2, Side.p].p + subregions[:, 1, :].gas.N2.faces[
        2, Side.p].p + subregions[:, 1, :].gas.O2.faces[2, Side.p].p

...
*/
    ...
    model AnCLPEM "Test the anode catalyst layer"
  ...
  */
    ...
    equation
      ...
      connect(PEM.xPositive, BC2.face) annotation (Line(
          ...
          thickness=0.5,
          smooth=Smooth.None));
      connect(PEM.xNegative, anCL.xPositive) annotation (Line(
          points={{-5.55112e-16,10},{-6,10},{-6,6.10623e-16},{-10,6.10623e-16}},

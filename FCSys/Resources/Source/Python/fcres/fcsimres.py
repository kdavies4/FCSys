...
from modelicares import unit2tex, label_number, label_quantity
from modelicares.base import (flatten_list, figure, setup_subplots, get_pow10,
                              convert)
...
#
    ...
    def colorfig(self, suffix, times=[0], n_rows=1, title="", subtitles=[],
        ...
        **Arguments:**
        ...
        - *\*\*kwargs*: Propagated to :meth:`modelicares.base.color`
        """
    ...
    def plotfig_subregions(self, prop, **kwargs):
        ...
        **Arguments:**
        ...
        - *\*\*kwargs*: Propagated to :meth:`modelicares.plot` (and thus to
    ...
    def quiverfig_subregions(self, vect, times=[0], n_rows=1,
        ...
        **Arguments:**
        ...
        - *\*\*kwargs*: Propagated to :meth:`modelicares.base.quiver` (and

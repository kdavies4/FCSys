    ...
    model CLToCL "Test one catalyst layer to the other"
      ...
      FCSys.BCs.FaceBus.SubregionFlow bC2[n_y, n_z](
        each gas(
          ...
          inclN2=true,
          inclO2=true,
          O2(redeclare FCSys.BCs.Face.Material.Pressure materialBC, materialSpec(
                k(start=1*U.atm))),
          H2O(redeclare FCSys.BCs.Face.Material.Pressure materialBC, materialSpec(
                k(start=1*U.atm)))),
        each graphite(
          inclC=true,
          'incle-'=true,
    ...
    model AnCL "Test the anode catalyst layer"
      ...
      FCSys.BCs.FaceBus.SubregionFlow bC2[n_y, n_z](
        each gas(
          inclH2=true,
          inclH2O=true,
          H2(redeclare FCSys.BCs.Face.Material.Pressure materialBC, materialSpec(
                k=1*U.atm)),
          H2O(redeclare FCSys.BCs.Face.Material.Pressure materialBC, materialSpec(
                k=1*U.atm))),
        each graphite(

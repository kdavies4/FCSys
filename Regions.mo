    ...
    model CLToCL "Test one catalyst layer to the other"
      ...
      Conditions.FaceBus.SubregionFlows condition2[n_y, n_z](
        each gas(
          ...
          inclN2=true,
          inclO2=true,
          O2(redeclare FCSys.Conditions.Face.Material.Density normal(source(k(
        ...
        each ionomer(
          'inclC19HF37O5S-'=true,
          'inclH+'=true,
          'H+'(redeclare FCSys.Conditions.Face.Material.Density normal(source(k(
